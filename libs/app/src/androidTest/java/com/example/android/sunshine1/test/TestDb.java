...
public class TestDb extends AndroidTestCase {
    ...
    //Anahat - Important. Android tests are executed in the order the tests are declared below. So testCreateDB will be executed before the next method testInsertReadDb
